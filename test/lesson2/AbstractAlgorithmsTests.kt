...
Но вреден север для меня
        ...
        assertEquals(" в Нанкинском университете", longestCommonSubstring("В возрасте десяти лет Уэст с матерью " +
                "переехал в город Нанкин в Китае, где они жили, пока она работала в Нанкинском университете по программе обмена.",
            "Десятки студентов и преподавателей университета прошли стажировку в Москве, Ленинграде и других городах " +
                    "Советского Союза. Немало и советских преподавателей читали лекции в Нанкинском университете."))
